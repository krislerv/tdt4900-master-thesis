...
import time
import numpy as np
from models_attn2 import InterRNN, IntraRNN
...
def train(input, target, session_lengths, session_reps, inter_session_seq_length, use_last_hidden_state):
    ...
    loss = 0
    decoder_context = Variable(torch.zeros(2, 1, INTRA_INTERNAL_SIZE))
    if use_cuda:
    ...
    for i in range(19):
        ...
        out, decoder_context, intra_hidden, embedded_input, gru = intra_rnn(c, decoder_context, intra_hidden, inter_output)
